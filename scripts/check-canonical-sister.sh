...
BENCH_FOUND=0
for bench_dir in "crates/agentic-${SISTER_KEY}/benches" "crates/agentic-${SISTER_KEY}-core/benches" "crates/${SISTER_KEY}/benches" "benches"; do
...
STRESS_FOUND=0
for test_dir in "crates/agentic-${SISTER_KEY}/tests" "crates/agentic-${SISTER_KEY}-core/tests" "crates/${SISTER_KEY}/tests" "tests"; do
  if [ -d "$test_dir" ]; then
    STRESS_HITS=0
